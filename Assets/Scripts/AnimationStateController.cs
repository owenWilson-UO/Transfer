...
public class AnimationStateController : MonoBehaviour
{
    ...
    [Header("Inspect")]
    [SerializeField] InputActionReference inspectButton;
    ...
    void Update()
    {
        ...
        if (inspectButton != null && inspectButton.action.triggered && tt.transferAmount > 0 && !tt.isPreparingThrow)
        {
