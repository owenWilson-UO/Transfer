...
public class UpgradeManagerUI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(upgradeMenuKey) && !playerMovement.isInSlowMotion && (upgradeData.maxSlowMotionDuration> 0f || upgradeData.maxTransferAmount > 0 || upgradeData.maxPsylinkAmount > 0))
        {
